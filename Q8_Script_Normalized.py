...
#function to create a truncated normal distribution with bounds 0-1
#with mean 'beta' and sd fixed
def get_truncated_normal(mean=0.5, sd=0.13, low=0, upp=1):
...
for i in range(1, 10001):
    ...
    X_new = get_truncated_normal(mean=beta_list[i-1])
    beta = X_new.rvs()
...
batch_means = []
for j in range(1000, 10001, 300): #step size of 3000
